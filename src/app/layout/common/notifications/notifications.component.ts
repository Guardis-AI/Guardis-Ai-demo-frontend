...
export class NotificationsComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
      ...
      const data = {"p_user_id":localStorage.getItem('userId'),"p_device_token":"","p_device_type":"","p_device_id":"","login_user_id":localStorage.getItem('userId'),"p_notification_log_id":"","p_read_flag":"N"}
    ...
    toggleRead(notification,index): void
    {
        ...
        const data = {"login_user_id":localStorage.getItem('userId'),"p_device_token":"","p_device_type":"","p_device_id":"","p_notification_id":notification.notification_log_id}
