...
export const appRoutes: Route[] = [
    ...
    {path: 'signed-in-redirect', pathMatch : 'full', redirectTo: 'playback'},
  ...
  
    {
        ...
        children: [
            ...
            {path: 'playback', loadChildren: () => import('app/modules/admin/playback/playback.module').then(m => m.PlaybackModule)},
            {path: 'setting', loadChildren: () => import('app/modules/admin/setting/setting.module').then(m => m.SettingModule)},
            {path: 'live', loadChildren: () => import('app/modules/admin/livestream/livestream.module').then(m => m.LivestreamModule)},
            {path: 'viewnotifications', loadChildren: () => import('app/modules/admin/viewnotifications/viewnotifications.module').then(m => m.ViewnotificationsModule)},
